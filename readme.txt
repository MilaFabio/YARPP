...
== Description ==
NOTE : This is a fork to enable us to continue maintenance of the plugin until it becomes clear. Taken from version 4.4
...
= 4.4.1 =
* Fixed get_currentuserinfo() deprecated warning
...
= 3.1.3 =
* Performance improvements:yarpp
